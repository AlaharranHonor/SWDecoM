...
public class PressurePlateGen extends BasicBlockGen<PressurePlateBlock> {
    ...
    protected PressurePlateBlock generate() {
        return new PressurePlateBlock(this.sensitivity, this.props().noCollission(), BlockSetType.OAK);
    }
    ...
    public void addBlockStates(BlockStateGen gen, TextureSet textures) {
        ...
        ResourceLocation basePath = new ResourceLocation(blockKey(this.baseBlock.get()).getNamespace(), path.substring(0, path.length() - 15));
