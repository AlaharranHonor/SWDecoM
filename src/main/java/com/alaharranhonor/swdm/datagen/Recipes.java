...
public class Recipes extends RecipeProvider {
    ...
    private void misc(Consumer<FinishedRecipe> recipe) {
        //ShapedRecipeBuilder.shaped(BlockInit.CHANGE_TOOL.get()).define('N', Tags.Items.NUGGETS_IRON).define('S', Tags.Items.RODS_WOODEN).pattern("NN ").pattern(" SN").pattern(" S ").unlockedBy("has_iron_nugget", RecipeProvider.has(Tags.Items.NUGGETS_IRON));
    }
    ...
    private void sets(Consumer<FinishedRecipe> recipe) {
        ...
        for (int i = 0; i < com.alaharranhonor.swdm.SWDM.STONE_TYPES.size(); i++) {
            String type = com.alaharranhonor.swdm.SWDM.STONE_TYPES.get(i);
            int finalI = i;
            com.alaharranhonor.swdm.SWDM.STONE_SETS.get("standard").forEach((stone, block) -> {
        ...
        for (int i = 0; i < com.alaharranhonor.swdm.SWDM.LMD_TYPES.size(); i++) {
            String lmd = com.alaharranhonor.swdm.SWDM.LMD_TYPES.get(i);
        ...
        for (String tone : com.alaharranhonor.swdm.SWDM.NATURAL_TONES) {
        ...
        for (RegistryObject<Block> rb : BlockInit.SSW_SET_BLOCKS.get("lmd-color", "siding")) {
            ...
            if (parts[2].equals("light")) {
                ...
                ShapelessRecipeBuilder.shapeless(rb.get(), 8).requires(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(com.alaharranhonor.swdm.SWDM.MOD_ID, parts[0] + "_" + parts[1] + "_medium"))).requires(Items.WHITE_DYE).group("siding").unlockedBy("has_slabs", has(ItemTags.WOODEN_SLABS)).save(recipe, rb.get().getRegistryName().getPath() + "_from_medium");
                ...
                ShapelessRecipeBuilder.shapeless(rb.get(), 8).requires(ForgeRegistries.BLOCKS.getValue(new ResourceLocation(com.alaharranhonor.swdm.SWDM.MOD_ID, parts[0] + "_" + parts[1] + "_medium"))).requires(Items.BLACK_DYE).group("siding").unlockedBy("has_slabs", has(ItemTags.WOODEN_SLABS)).save(recipe, rb.get().getRegistryName().getPath() + "_from_medium");
            }
        }
    ...
    */
    ...
    private static void stairs(Consumer<FinishedRecipe> p_240480_0_, ItemLike resultItem, ItemLike craftingItem, String group, String unlockedBy) {
        ShapedRecipeBuilder.shaped(resultItem, 4).define('#', craftingItem).pattern("#  ").pattern("## ").pattern("###").group(group + "_stairs").unlockedBy(unlockedBy, RecipeProvider.has(craftingItem)).save(p_240480_0_);
    }
    ...
    private static void stoneStairs(Consumer<FinishedRecipe> p_240480_0_, ItemLike resultItem, ItemLike craftingItem, String group) {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(craftingItem), resultItem).unlockedBy("has_stone", RecipeProvider.has(craftingItem)).save(p_240480_0_, resultItem.asItem().getRegistryName().getPath() + "_from_" + craftingItem.asItem().getRegistryName().getPath() + "_stonecutting");
    }
    ...
    private static void slab(Consumer<FinishedRecipe> p_240479_0_, ItemLike resultItem, ItemLike craftingItem, String group, String unlockedBy) {
        ShapedRecipeBuilder.shaped(resultItem, 6).define('#', craftingItem).pattern("###").group(group + "_slab").unlockedBy(group, RecipeProvider.has(craftingItem)).save(p_240479_0_);
        ShapedRecipeBuilder.shaped(craftingItem).define('#', resultItem).pattern("#").pattern("#").unlockedBy(unlockedBy, RecipeProvider.has(resultItem)).save(p_240479_0_, new ResourceLocation(SWDM.MOD_ID, craftingItem.asItem() + "_from_slabs")); // Two slabs to block
    }
    ...
    private static void stoneSlab(Consumer<FinishedRecipe> p_240479_0_, ItemLike resultItem, ItemLike craftingItem, String group) {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(craftingItem), resultItem, 2).unlockedBy("has_stone", RecipeProvider.has(craftingItem)).save(p_240479_0_, resultItem.asItem().getRegistryName().getPath() + "_from_" + craftingItem.asItem().getRegistryName().getPath() + "_stonecutting");
    }
    ...
    private static void wall(Consumer<FinishedRecipe> p_240479_0_, ItemLike resultItem, ItemLike craftingItem, String group, String unlockedBy) {
        ShapedRecipeBuilder.shaped(resultItem, 6).define('#', craftingItem).pattern("###").pattern("###").group(group + "_wall").unlockedBy(unlockedBy, RecipeProvider.has(craftingItem)).save(p_240479_0_);
    }
    ...
    private static void stoneWall(Consumer<FinishedRecipe> p_240479_0_, ItemLike resultItem, ItemLike craftingItem, String group) {
        ...
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(craftingItem), resultItem).unlockedBy("has_stone", RecipeProvider.has(craftingItem)).save(p_240479_0_, resultItem.asItem().getRegistryName().getPath() + "_from_" + craftingItem.asItem().getRegistryName().getPath() + "_stonecutting");
    }
    ...
    private static void pressurePlate(Consumer<FinishedRecipe> p_240479_0_, ItemLike resultItem, ItemLike craftingItem, String group, String unlockedBy) {
        ShapedRecipeBuilder.shaped(resultItem, 1).define('#', craftingItem).pattern("##").group(group + "_pressure_plate").unlockedBy(unlockedBy, RecipeProvider.has(craftingItem)).save(p_240479_0_);
    }
    ...
    private static void button(Consumer<FinishedRecipe> p_240479_0_, ItemLike resultItem, ItemLike craftingItem, String group, String unlockedBy) {
        ShapelessRecipeBuilder.shapeless(resultItem, 1).requires(craftingItem).group(group + "_button").unlockedBy(unlockedBy, RecipeProvider.has(craftingItem)).save(p_240479_0_);
    }
    ...
    private static void carpet(Consumer<FinishedRecipe> p_240479_0_, ItemLike resultItem, ItemLike craftingItem, String group) {
        ShapedRecipeBuilder.shaped(resultItem, 3).define('#', craftingItem).pattern("##").group(group).unlockedBy("has_something", RecipeProvider.has(craftingItem)).save(p_240479_0_);
    }

    private static void glassPane(Consumer<FinishedRecipe> p_240479_0_, ItemLike resultItem, ItemLike craftingItem, String group) {
        ShapelessRecipeBuilder.shapeless(resultItem, 16).requires(craftingItem).group(group).unlockedBy("has_something", RecipeProvider.has(craftingItem)).save(p_240479_0_);
    }
}
