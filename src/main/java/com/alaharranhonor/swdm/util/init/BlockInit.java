...
import com.alaharranhonor.swdm.block.ModdedStandingSignBlock;
import com.alaharranhonor.swdm.block.ModdedWallSignBlock;
...
public class BlockInit {
    ...
    static {
        ...
        for (String stoneType : SWDM.STONE_TYPES) {
            ...
            for (Map.Entry<String, Block.Properties> blockType : SWDM.STONE_SETS.get("standard").entrySet()) {
                ...
                stairList.add(register(stoneType + "_" + blockType.getKey() + "_stairs", () -> new StairBlock(() -> finalStairBlock.get().defaultBlockState(), blockType.getValue())));
            ...
            for (String lmdType : SWDM.LMD_TYPES) {
                for (Map.Entry<String, Block.Properties> blockType : SWDM.STONE_SETS.get("lmd").entrySet()) {
                    ...
                    List<RegistryObject<StairBlock>> stairList = stairMap.getOrDefault(blockType.getKey(), new ArrayList<>());
                    stairList.add(register(stoneType + "_" + lmdType + "_" + blockType.getKey() + "_stairs", () -> new StairBlock(() -> new Block(blockType.getValue()).defaultBlockState(), blockType.getValue())));
                    stairMap.put(blockType.getKey(), stairList);
        ...
        for (String lmdType : SWDM.LMD_TYPES) {
            for (Map.Entry<String, Block.Properties> blockType : SWDM.STONE_SETS.get("lmd-only").entrySet()) {
                ...
                List<RegistryObject<StairBlock>> stairList = stairMap.getOrDefault(blockType.getKey(), new ArrayList<>());
                stairList.add(register(lmdType + "_" + blockType.getKey() + "_stairs", () -> new StairBlock(() -> new Block(blockType.getValue()).defaultBlockState(), blockType.getValue())));
                stairMap.put(blockType.getKey(), stairList);
        ...
        for (DyeColor color : DyeColor.values()) {
            ...
            COATED_CHAINS.add(register("coated_chain_" +color.getName(), () -> new CoatedChain(Block.Properties.of(Material.METAL, MaterialColor.NONE).requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.CHAIN).noOcclusion())));
            ...
            for (Map.Entry<String, Block.Properties> blockType : SWDM.SSW_SETS.get("color").entrySet()) {
                ...
                stairList.add(register(color.getName() + "_" + blockType.getKey() + "_stairs", () -> new StairBlock(() -> finalStairBlock.get().defaultBlockState(), blockType.getValue())));
                ...
                if (blockType.getKey().equals("pastel_wool") || blockType.getKey().equals("tinted_wool")) {
                    ...
                    carpetList.add(register(color.getName() + "_" + blockType.getKey() + "_carpet", () -> new CarpetBlock(blockType.getValue())));
        ...
        for (String color : SWDM.CUSTOM_COLORS) {
            ...
            for (Map.Entry<String, Block.Properties> blockType : SWDM.STONE_SETS.get("color_custom").entrySet()) {
                ...
                List<RegistryObject<StairBlock>> stairList = stairMap.getOrDefault(blockType.getKey(), new ArrayList<>());
                Supplier<Block> finalStairBlock = stairBlock;
                stairList.add(register(color + "_" + blockType.getKey() + "_stairs", () -> new StairBlock(() ->finalStairBlock.get().defaultBlockState(), blockType.getValue())));
                stairMap.put(blockType.getKey(), stairList);
        ...
        WoodType.values().forEach((wood) -> {
            ...
            if (!wood.name().equals("crimson") && !wood.name().equals("warped") && !wood.name().contains(":")) { // Vanilla wood types.
                ...
                beamList.add(register(sanitizedWoodName + "_beam", () -> new BeamBlock(Block.Properties.of(Material.WOOD, MaterialColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD))));
                ...
                for (Map.Entry<String, Block.Properties> blockType : SWDM.SSW_SETS.get("wv").entrySet()) {
                    ...
                    List<RegistryObject<StairBlock>> stairList = stairMap.getOrDefault(blockType.getKey(), new ArrayList<>());
                    Supplier<Block> finalStairBlock = stairBlock;
                    stairList.add(register(typeName + "_stairs", () -> new StairBlock(() -> finalStairBlock.get().defaultBlockState(), blockType.getValue())));
                    stairMap.put(blockType.getKey(), stairList);
        ...
        SWDM.LMD_TYPES.forEach((lmdType) -> {
            for (Map.Entry<String, Block.Properties> blockType : SWDM.SSW_SETS.get("lmd").entrySet()) {
                ...
                List<RegistryObject<StairBlock>> stairList = stairMap.getOrDefault(blockType.getKey(), new ArrayList<>());
                Supplier<Block> finalStairBlock = stairBlock;
                stairList.add(register(lmdType + "_" + blockType.getKey() + "_stairs", () -> new StairBlock(() -> finalStairBlock.get().defaultBlockState(), blockType.getValue())));
                stairMap.put(blockType.getKey(), stairList);
                ...
                if (blockType.getKey().equals("screen")) {
                    ...
                    beamList.add(register(lmdType + "_" + blockType.getKey() + "_glass_pane", () -> new StainedGlassPaneBlock(DyeColor.BLACK, blockType.getValue())));
                    beamMap.put(blockType.getKey(), beamList);
        ...
        for (String natural : SWDM.NATURAL_TONES) {
            ...
            FIBER_CARPETS.add(register("fiber_carpet_" + natural, () -> new CarpetBlock(Block.Properties.of(Material.CLOTH_DECORATION, MaterialColor.COLOR_BLACK).strength(0.1F).sound(SoundType.WOOL).noOcclusion())));
        }
        ...
        for (DyeColor color : DyeColor.values()) {
            for (String lmdType : SWDM.LMD_TYPES) {
                ...
                for (Map.Entry<String, Block.Properties> blockType : SWDM.SSW_SETS.get("lmd-color").entrySet()) {
                    ...
                    List<RegistryObject<StairBlock>> stairList = stairMap.getOrDefault(blockType.getKey(), new ArrayList<>());
                    Supplier<Block> finalStairBlock = stairBlock;
                    stairList.add(register(blockType.getKey() + "_" + color.getName() + "_" + lmdType + "_stairs", () -> new StairBlock(() -> finalStairBlock.get().defaultBlockState(), blockType.getValue())));
                    stairMap.put(blockType.getKey(), stairList);
   ...
   public static final RegistryObject<Block> THATCH_BLOCK = register("thatch_block", () -> new RotatedPillarBlock(Block.Properties.of(Material.PLANT).sound(SoundType.WET_GRASS).strength(0.5F, 0.5F))); // .harvestTool(ToolType.HOE)
    ...
    public static final RegistryObject<Block> GRASS_SLAB = register("grass_slab", () -> new SlabBlock(Block.Properties.copy(Blocks.GRASS_BLOCK)));
    public static final RegistryObject<Block> DIRT_SLAB = register("dirt_slab", () -> new SlabBlock(Block.Properties.copy(Blocks.DIRT)));
