...
import com.alaharranhonor.swdm.old.block.BeamBlock;
...
public class SWEMInit {
    ...
    public static void intializeModItems(RegistryEvent.Register<Item> item) {
        if (ModList.get().isLoaded("swem")) {
            ...
            //item.getRegistry().register(new MedicalItem(new Item.Properties().tab(com.alaharranhonor.swdm.SWDM.SWDMTAB), 20, 0).setRegistryName("test_item"));
